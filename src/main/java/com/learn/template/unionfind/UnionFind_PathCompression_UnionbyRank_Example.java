...
public class UnionFind_PathCompression_UnionbyRank_Example {
    public static void main(String[] args) throws Exception {
        UnionFind_PathCompression_UnionbyRank_Example uf = new UnionFind_PathCompression_UnionbyRank_Example(10);
        // 1-2-5-6-7 3-8-9 4
        uf.union(1, 2);
        uf.union(2, 5);
        uf.union(5, 6);
    ...
    public UnionFind_PathCompression_UnionbyRank_Example(int size) {
        root = new int[size];
        rank = new int[size];
