...
public class Q298_Binary_Tree_Longest_Consecutive_Sequence {
    ...
    public static void main(String[] args) {
        ...
        maxLen1 = 0; maxLen = 0; System.out.println("Test1: " + (solution.longestConsecutive1(root1) == 3)); // true
        ...
        maxLen1 = 0; maxLen = 0; System.out.println("Test2: " + (solution.longestConsecutive1(root2) == 2)); // true
        // 用例3: 所有节点相同 [5,5,5], 最长只有1
        TreeNode root3 = new TreeNode(5);
        root3.left = new TreeNode(5);
        root3.right = new TreeNode(5);
        maxLen1 = 0; maxLen = 0; System.out.println("Test3: " + (solution.longestConsecutive1(root3) == 1)); // true
        // 用例4: 空树
        maxLen1 = 0; maxLen = 0; System.out.println("Test4: " + (solution.longestConsecutive1(null) == 0)); // true
        // 用例5: 只有一个节点
        TreeNode root5 = new TreeNode(42);
        maxLen1 = 0; maxLen = 0; System.out.println("Test5: " + (solution.longestConsecutive1(root5) == 1)); // true
    }
    /**
